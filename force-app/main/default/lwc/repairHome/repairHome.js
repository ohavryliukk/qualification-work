...
export default class RepairHome extends NavigationMixin(LightningElement) {
    parameters;
    token;
    payload;
    user;
    ...
    handleToastMessage(event) {
        this.template.querySelector('c-custom-toast').showToast(event.detail.type, event.detail.message);
    }

    handleRefresh() {
        this.template.querySelector('c-opened-repair-request-carousel').refreshCarousel();
        this.template.querySelector('c-repair-requests-history').refreshTable();
    }
